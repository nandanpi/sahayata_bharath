        ...
        <>
          <div className=" bg-beige dark:bg-grey text m-3 rounded-xl ">
                <ul className="hidden md:flex text-teal dark:text-blue space-x-4 items-center justify-center">
                    <li onclick="showDiv('div1')" className="p-5 cursor-pointer">Food Schemes</li> 
                    <li onclick="showDiv('div2')" className="p-5 cursor-pointer">Service Schemes</li>
                    <li onclick="showDiv('div3')" className="p-5 cursor-pointer">Healthcare Schemes</li>
                    <li onclick="showDiv('div4')" className="p-5 cursor-pointer">Farming Schemes</li> 
                    <li onclick="showDiv('div5')" className="p-5 cursor-pointer">Finance Schemes</li> 
                    <li onclick="showDiv('div6')" className="p-5 cursor-pointer">Others</li>
                    <li onclick="showDiv('div7')" className="p-5 cursor-pointer">All</li>
                </ul>
            </div>
        <div className=" bg-beige dark:bg-grey text-teal dark:text-blue space-y-2 rounded-xl mx-3">
